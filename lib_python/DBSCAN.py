...
def ExpandClusterOrder(SetOfObjects , Object , epsi = 10000 , MinPts = 2 , listadoTuplas = [(),()] ):
	...
	listadoTuplas.append( ( Object.fecha , Object.hora , Object.latitud , Object.longitud , Object.reachability_distance , Object.core_distance ))
	...
	if Object.core_distance != 1000000:
		...
		while OrderSeeds != []:
			...
			# En las siguientes dos lineas se escribe el punto en estudio
			listadoTuplas.append((currentObject.fecha , currentObject.hora , currentObject.latitud , currentObject.longitud , currentObject.reachability_distance , currentObject.core_distance ))
...
def FOptics( SetOfObjects , epsi , MinPts ):
	...
	for Object in SetOfObjects.listadoInstancias:
		...
		print(SetOfObjects.listadoInstancias.index(Object) ,len(SetOfObjects.listadoInstancias))
		...
		if not Object.Processed:
			...
			if not neighbors == []:
				for El_neighbor in neighbors:
					...
					print(neighbors.index(El_neighbor) ,len(neighbors))
...
class SetOfObjects:
	...
	def __init__(self, listadoTuplas = [(),(),()]):
		...
		for tupla in self.listadoTuplas:
			...
			instancia = Object( nombre = tupla[1] , fecha = tupla[2] , hora = tupla[3] , latitud = tupla[4] , longitud = tupla[5])
	...
	def neighbors(self, Object , epsi):
		...
		# En esta lista se van guardando las instancias que 
		vecinosDesordenados = []
...
class Object:
	...
	def __init__(self, nombre="" , fecha = date(2013,01,01) , hora = timedelta( 0, 1000) , latitud = Decimal('-33.00'), longitud = Decimal('-70.00') ):
